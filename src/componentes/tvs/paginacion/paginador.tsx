...
export const Paginador: React.FC<IPaginadorProps> = ({ elementsPaginacion, setElementsPaginacion, setExecuteConsultaList, executeConsultaList }) => {
    ...
    const cambiaPagina = (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        setExecuteConsultaList(!executeConsultaList)
    }
